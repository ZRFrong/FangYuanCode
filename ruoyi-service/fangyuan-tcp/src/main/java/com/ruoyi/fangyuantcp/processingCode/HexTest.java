...
public class HexTest {
    ...
    private void sensor(String s,String heartbeatText){
        ...
        DbTcpType build = DbTcpType.builder()
                .heartName(heartbeatText+dbEquipmentComponentClient.selectByHeartbeatText(heartbeatText))
        ...
        if (list.size()>7){
            build.toBuilder()
                    ...
                    .ph(Integer.parseInt(list.get(9), 16) + "")
        ...
        dbEquipmentComponentClient.selectByHeartbeatText(heartbeatText);
        if (i == null){
