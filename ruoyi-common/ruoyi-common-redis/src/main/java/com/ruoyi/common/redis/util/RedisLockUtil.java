...
public class RedisLockUtil {
    ...
    public void lock(String key, String value, Integer timeout)  {
        Assert.isTrue(!StringUtils.isEmpty(key), "redis locks are identified as null.");
        Assert.isTrue(!StringUtils.isEmpty(value), "the redis release lock is identified as null.");
        int cycles = CYCLES;
