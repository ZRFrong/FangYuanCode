...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils
{
    ...
    public static Date getType(String type, Integer i) {
        ...
        if (type.equals(HOUR)) {
            calendar.add(Calendar.HOUR, i);//当前系统时间的  前i小时
            return calendar.getTime();
        }else if (type.equals(DAY)){
            calendar.add(Calendar.DATE, i);//当前系统时间的  前i天
            return calendar.getTime();
        }else if (type.equals(SECONDS)){
            calendar.add(Calendar.SECOND, i);//当前系统时间 的   前i 秒的时间
            return calendar.getTime();
        }else if (type.equals(MINUTE)){
            calendar.add(Calendar.MINUTE, i);//当前系统时间 的   前i 分的时间
            return calendar.getTime();
        }else {
            return null;
        }
